...
$counter = 0;
$verified = 0;
$people = $sql->getById("SELECT id, name,phone,profile_progress,verification_status FROM User WHERE status='1' AND user_type='volunteer' AND city_id=$city_id ORDER BY profile_progress DESC");
